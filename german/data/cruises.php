              ...
              <TD rowspan="2" vAlign=top><div align="center"> 
                  <TABLE cellSpacing=3 cellPadding=5 width=430 border=0>
                    <TBODY>
                      ...
                      <TR> 
                        <TD height="28"><a href="admin.php">Back to List</a> | 
                          <a href="cruises.php">Add</a> | <a href="admin.php?id=<?php echo ($id);?>" onClick="return confirmdel()">Delete</a> 
                          | <a href="logout.php" onClick="return confirmlogout()">Logout</a></TD>
                      </TR>
                      <TR> 
