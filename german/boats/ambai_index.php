              ...
              <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td bgcolor="#2E3C9D"><table width="100%"  border="0" cellpadding="1" cellspacing="1">
                    <tr>
                      <td height="18" bgcolor="#006699"><span class="style1">&nbsp;&nbsp;<strong>Die MVAmbai</strong></span></td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                          <td colspan="2"><p align="center"><span class="style15"><br>
                                <span class="style90">Das traditionelle Holz-Motorboot MV Ambai</span></span><span class="style2"><br>
                                <br>
                                </span></p>
                            <p align="center"><a href="ambai/ambai_profil.jpg" target="_blank"><img src="ambai/ambai_profil.jpg" alt="sulawesi liveaboard dive cruise boat ambai" width="448" height="157" border="0"></a></p>
                            <p align="left" class="style12"><b>Our new boat, now under construction in Sulawesi, will receive
                              up to 16 divers in absolute comfort.
                              Traditionally built from iron wood and other tropical hard woods,
                              her design is however especially conceived as dive cruise boat.</b></p>
                            <p align="left" class="style12">Her 8 cabins will all have individually controlled air conditioned, private bathroom with hot water.
                              An inside lounge and restaurant, large shadow deck areas, and a Sun deck will be the common parts.<br>
                <br>
                <a href="ambai/ambai_decks.jpg" target="_blank"><img src="ambai/ambai_decks.jpg" alt="Cliquer pour agrandir" width="233" height="151" hspace="10" vspace="10" border="0" align="right" class="picright"></a> <b>At the rear of the boat, a large dive deck extended by a dive
                  platform will offer an easy and direct access to the three dive tenders.</b> <br>
  <br>
                              The photographers will enjoy a dedicated room for the maintenance and preparation of their cameras,
                              as well as a large screen in the lounge to  share pictures and videos. <br>
                <br>
                <b>Four great Indonesian dive guides and a Western instructor and
                  cruise director will accompany you underwater and make all your dives a
                  safe a enjoyable experience.</b></p>
                            <p align="center" class="style89">&nbsp;</p>
                            <p align="left">&nbsp;</p></td>
                        </tr>
                        <tr>
                          <td colspan="2"><div align="center"><span class="style12"><span class="style29"><span class="style30"><a href="ambai_boatdetails.php">- Bootsdetails</a></span></span><a href="#"></a></span></div></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><span class="style91">ambai liveaboard tauchkreuzfahrten in indonesien,tauchfahrten,tauchtrips,<br>
                  segeltouren,tauchen,tauchausbildung,tauchen in sulawesi,tauchen in Komodo,Raya Ampat, steilwandtauchen,Rifftauchen,
                  Komodo Marine Park,Komodo Drachen,Komodo national Park,Tauchschiffe
...
<a href="mailto:cruises@indonesialiveaboard.com" class="style32">Bitte emailen sie uns fuer Reservierungen!</a><br>
