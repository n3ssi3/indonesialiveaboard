...
.style34 {font-size: 9pt; font-weight: bold; }
.style35 {
	font-size: 16;
	color: #000000;
	font-weight: bold;
}
.style37 {font-size: 16px; color: #000000; font-weight: bold; }
.style1 {color: #0000CC}
                        ...
                        <table width="116"  border="0" align="left" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td><div align="center"><img src="../images/englishflag.gif" width="43" height="30" border="0" usemap="#MapMap"><br>
                                    ...
                                    <map name="MapMap">
                                      <area shape="rect" coords="-3,-5,41,23" href="dive_resort_tulamben/accommodation.php">
                                    </map>
                            </div></td>
                          </tr>
                        </table>
  ...
  <TR>
    <TD bgColor=#ffffff>
      <TABLE cellSpacing=0 cellPadding=0 width="775" border=0>
        <TBODY>
        <TR>
              <TD width=285 align=middle vAlign=top bgcolor="#4DCEE3"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><div align="center"><br>
                        <img src="resortimages/mapb.jpg" alt="indonesien_liveaboard_tauchfahrten_sport_tauch_kreuzfahrten_tauch_hotel_resort_bali" width="278" height="176"><br>
...
Tauch Terminal Liveaboard</strong></a><strong></strong><br>
  ...
  <br>
                ...
                <p align="center">&nbsp;</p>
                <p align="center">                  <br>
                <img src="resortimages/poolgirl.jpg" alt="indonesien_liveaboard_tauchfahrten_sport_tauch_kreuzfahrten_tauch_hotel_resort_bali" width="194" height="159" border="1"> <br>
                <br>
</p>
              </TD>
          ...
          <TD width="480" vAlign=top>
            <div align="center">
              <table width="100%"  border="0" cellspacing="3" cellpadding="3">
                <tr>
                  <td><p align="center">&nbsp;</p>
                    <p align="center" class="style14">Unterk<span class="style14">&uuml;</span>nfte</p>
                    <p align="left" class="14wh style15"> Unsere Zimmer sind nach dem Prinzip einer freundlichen Atmosph&auml;re, einer warmen Ausstrahlung und einem Maximum an Komfort designd. Sobald sie unsere Zimmer betreten, werden sie von unserem hervorragenden Design positiv &uuml;berrascht sein. Unsere Zimmer repr&auml;sentieren eine perfekte Balance an Architektur und Funktionalit&auml;t. Die balinesische Holzeinrichtung in Kombination mit den wei&szlig;en Strukturputzw&auml;nden sorgen f&uuml;r ein helles und sauberes Ambiente. </p>
                    <p align="center" class="14wh style15"><img src="resortimages/diveresort_2.jpg" alt="Bali Tulamben Dive Resort Hotel &amp; Dive Center" width="426" height="97"></p>
                    <p align="left" class="14wh style15">                      Gro&szlig;e Glast&uuml;ren und Fenster sorgen  den ganzen Tag &uuml;ber f&uuml;r reichlichen Lichteinfall.  9 Deluxe Bungalows, 10 Super Deluxe Zimmer, 1 Hochzeits-Suite
                      (mit 2 Badezimmern und extra Wohnzimmer), <br>
                      1 Familien-Zimmer (2 Badezimmer plus extra Schlafzimmer) warten auf Entspannungshungrige Besucher.</p>
                    <p align="center"><span class="style14">Zimmerpreise</span><br>
                        <span class="14wh"><br>
                        </span><span class="style15">Zimmerpreise inclusive Continental Fr<span class="14wh style15">&uuml;</span>hst<span class="14wh style15">&uuml;</span>ck: </span><span class="14wh"><br>
                        </span></p>
                    <div align="center">
                      <table width="286" border="0" cellspacing="0" cellpadding="0">
                        <tr class="style15">
                          <td width="165" class="14wh"><strong>Bungalow</strong></td>
                          <td width="121" class="14wh"><strong>US$ 60.-</strong></td>
                        </tr>
                        <tr class="style15">
                          <td class="14wh"><strong>Superdeluxe Zimmer </strong></td>
                          <td class="14wh"><strong>US$ 80.-</strong></td>
                        </tr>
                        <tr class="style15">
                          <td class="14wh"><strong>Familien-Zimmer</strong></td>
                          <td class="14wh"><strong>US$ 135.-</strong></td>
                        </tr>
                        <tr class="style15">
                          <td class="14wh"><strong>Hochzeits-Suite</strong></td>
                          <td class="14wh"><strong>US$ 135.-</strong></td>
                        </tr>
                        <tr class="style15">
                          <td class="style34">&nbsp;</td>
                        ...
                        <tr class="style15">
                          <td class="14wh"><strong>Transfer Airport- <br>
        Tulamben - Airport</strong></td>
                          <td class="14wh"><strong>US$ 50.- p. Person</strong></td>
                        </tr>
                        <tr class="style15">
                          <td class="style15"><div align="left"><strong><span class="14wh">Flat rate for 4 bis 8 Pers</span></strong></div></td>
                          <td class="14wh"><strong>US$ 180.- </strong></td>
                        </tr>
                      </table>
                    </div>
                    <p align="center"><img src="resortimages/deluxe_room.jpg" width="400" height="267"><br>
                      <strong><br>
                      <span class="style33">DeLuxe Room</span></strong><br>
                      <br>
                    </p>                    </td>
                </tr>
              </table>
              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><img src="resortimages/accopic1.jpg" alt="indonesien_liveaboard_tauchfahrten_sport_tauch_kreuzfahrten_tauch_hotel_resort_bali" width="150" height="99" border="1"></td>
                  <td><img src="resortimages/accopic3.jpg" alt="indonesien_liveaboard_tauchfahrten_sport_tauch_kreuzfahrten_tauch_hotel_resort_bali" width="150" height="99" border="1"></td>
                  <td><img src="resortimages/accopic2.jpg" alt="indonesien_liveaboard_tauchfahrten_sport_tauch_kreuzfahrten_tauch_hotel_resort_bali" width="150" height="99" border="1"></td>
                </tr>
              </table>
              <br>
              <span class="style33">Familien Zimmer              </span>
              <p class="style14"><span class="12wh"><span class="style17"><strong><span class="style23"><br>
                        <strong><span class="style33">Bitte besuchen sie auch unsere spezielle Tauch Resort Webseite:</span></strong></span></strong><a href="http://www.tulamben.com"><strong></strong></a></span></span><br>
                        <br>
                <span class="style17"><a href="http://www.tulamben.com"><strong>www.tulamben.com</strong></a><br>
                <br>
                </span></p>
              </div></TD>
