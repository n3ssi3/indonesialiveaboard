    ...
    <tr> 
      ...
      <td> <font face="Times New Roman, Times, serif" color="#4B4B87" size="2"> 
        ...
        <select name="departure_date_mm" id="monthin" >
          ...
          <option value="2006"<? if ($departure_date_yyyy=="2006") echo("selected");?>>2006</option>
          <option value="2007"<? if ($departure_date_yyyy=="2007") echo("selected");?>>2007</option>
          <option value="2008"<? if ($departure_date_yyyy=="2008") echo("selected");?>>2008</option>
          <option value="2009"<? if ($departure_date_yyyy=="2009") echo("selected");?>>2009</option>
          <option value="2010"<? if ($departure_date_yyyy=="2010") echo("selected");?>>2010</option>
          <option value="2011"<? if ($departure_date_yyyy=="2011") echo("selected");?>>2011</option>
          <option value="2012"<? if ($departure_date_yyyy=="2012") echo("selected");?>>2012</option>
          <option value="2013"<? if ($departure_date_yyyy=="2013") echo("selected");?>>2013</option>
          <option value="2014"<? if ($departure_date_yyyy=="2014") echo("selected");?>>2014</option>
          <option value="2015"<? if ($departure_date_yyyy=="2015") echo("selected");?>>2015</option>
        </select> </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td> <font face="Times New Roman, Times, serif" color="#4B4B87" size="2"> 
        ...
        <select name="return_date_mm" >
          ...
          <option value="2006"<? if ($return_date_yyyy=="2006") echo("selected");?>>2006</option>
          <option value="2007"<? if ($return_date_yyyy=="2007") echo("selected");?>>2007</option>
          <option value="2008"<? if ($return_date_yyyy=="2008") echo("selected");?>>2008</option>
          <option value="2009"<? if ($return_date_yyyy=="2009") echo("selected");?>>2009</option>
          <option value="2010"<? if ($return_date_yyyy=="2010") echo("selected");?>>2010</option>
          <option value="2011"<? if ($return_date_yyyy=="2011") echo("selected");?>>2011</option>
          <option value="2012"<? if ($return_date_yyyy=="2012") echo("selected");?>>2012</option>
          <option value="2013"<? if ($return_date_yyyy=="2013") echo("selected");?>>2013</option>
          <option value="2014"<? if ($return_date_yyyy=="2014") echo("selected");?>>2014</option>
          <option value="2015"<? if ($return_date_yyyy=="2015") echo("selected");?>>2015</option>
        </select> </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
