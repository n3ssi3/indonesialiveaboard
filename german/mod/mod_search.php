...
?>
<form name="searchfrm" method="post" action="<?php echo ("$mosConfig_absolute_path/german/data/list_new.php");?>">
  ...
  <table width="100%" border="0" cellspacing="5" cellpadding="0">
    ...
    <tr>
      <td> <SELECT name="destination">
          <option value="0" >Tauchgebiete........... &gt;</option>
    ...
    <tr>
      <td> <input name="submit" type="submit" value="Suche">
        | <a href="<?php echo ("$mosConfig_absolute_path/german/data/login.php"); ?>">Manage Cruises</a></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
