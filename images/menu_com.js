...
function MbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
	...
	if(eval(WhatMenu+'[3]')&&ShowArrow){
		...
		if(DomYes){
			...
			t.style.top=T;
			t.style.left=L}
		else{	MemVal+="<div style='position:absolute; top:"+T+"; left:"+L+"; width:"+W+"; height:"+H+";visibility:inherit'><img src='../Jati%20Tour,%20Bali%20-%20Indonesia_files/%22%2BS%2B%22'></div>";
...
function NavMbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
	...
	if(this.value.indexOf('rollover')!=-1){
		...
		this.rid=WhatMenu+'i';this.value="<img src='../Jati%20Tour,%20Bali%20-%20Indonesia_files/%22%2Bthis.ri1%2B%22' name='"+this.rid+"'>"}
	...
	if(eval(WhatMenu+'[3]')&&ShowArrow){
		...
		ImgStr="<img src='../Jati%20Tour,%20Bali%20-%20Indonesia_files/%22%2BArrws%5Ba%5D%2B%22' width='"+Arrws[a+1]+"' height='"+Arrws[a+2]+"'>";
