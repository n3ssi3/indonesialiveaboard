                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="320" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td height="22" valign="top">&nbsp;&nbsp;<span class="style9"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><a href="../index.php">Hauptseite</a> | <a href="contactus.php">Kontaktadresse</a><a href="boats/contactus.php" class="style19"><strong> </strong></a><span class="style1"><strong>|</strong></span><a href="../partner_links.php" class="style19"><strong> Partner Links</strong></a></font></font></span></td>
                        </tr>
                        <tr>
                          <td><img src="../images/m1.jpg" alt="indonesia_liveaboard_scuba_diving" width="349" height="104"></td>
                        </tr>
                    </table></td>
                  </tr>
                  <tr bgcolor="#006699">
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="775" border=0>
        ...
        <TR>
          ...
          <TD width="474" vAlign=top><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td bgcolor="#2E3C9D"><table width="100%"  border="0" cellpadding="1" cellspacing="1">
                    <tr>
                      <td height="18" bgcolor="#006699"><span class="style1">&nbsp;&nbsp;<strong>Contact us </strong></span></td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
                        <tr>
                          <td width="100%"><p><br>
                              <span class="style22">Dear Liveaboard Guest, </span></p>
                            <p class="style22">please contact us for further information at our main office in Bali:  </p>                            
                            <p align="center" class="style21">Jl. Danau Tamblingan X, No. 31 <br>
             Jimbaran 8000, Bali - Indonesia<br>
            Phone: +62-361 - 774504/772920<br>
            Fax: +62-361 -778473 </p>
                            <p align="center" class="style21"><img src="../images/indexpage.jpg" width="428" height="223"></p>
                            <p align="center" class="style21"><strong><a href="mailto:cruises@indonesialiveaboard.com" class="style30">FOR BOOKINGS &amp; RESEVATIONS PLEASE EMAIL US</a></strong><br>
                                        <br></p>
                            <p class="style12">For your prefered language please ask for:</p>
                            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                              <tr class="style21">
                                <td class="style21">German:</td>
                                <td class="style11">Axel or Patrick </td>
                              </tr>
                              <tr class="style21">
                                <td class="style21">English:</td>
                                <td class="style11"> Robert  or Patrick </td>
                              </tr>
                              <tr class="style21">
                                <td class="style21">Indonesian:</td>
                                <td class="style11">Robert </td>
                              </tr>
                              <tr class="style21">
                                <td class="style21">Malaysian:</td>
                                <td class="style11"> Robert </td>
                              </tr>
                              <tr class="style21">
                                <td class="style21">French:</td>
                                <td class="style11"><strong>Patrick</strong></td>
                              </tr>
                              <tr class="style21">
                                <td class="style21">Spanisch:</td>
                                <td class="style11"><strong>Patrick</strong></td>
                              </tr>
                            </table>                            
                            <p align="center"><strong></strong><img src="../images/indomap.jpg" width="420" height="110" border="0"><br>                            
                                      </p>                                                        </td>
                          </tr>
                      </table></td>
                    </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><span class="style42">indonesian liveaboard scuba diving cruises,diving cruises,bali,diving,dive resort,wreck diving,dive komodo,dive flores,dive alor,dive banta,dive trip,dive sulawesi,dive sumbawa,dive lombok,dive irian jaya,sailing boat,vessel,island cruises,sailing ship cruises,indonesian exploreation cruises,indonesian dive destinations,dive adventure,luxury liveaboard,exclusive liveaboard,resort aboard, </span></td>
              </tr>
            </table>
            </TD>
