   ...
   if( $_SESSION['security_code'] == $_POST['security_code'] && !empty($_SESSION['security_code'] ) ) {
		// Insert you code for processing the form here, e.g emailing the submission, entering it into a database. 
			...
			$pesan ='<strong>Name : '.$_POST['name'].'</strong><br>
						...
						<br>link : <a href="http://indonesialiveaboard.com/data/listdetail.php?id='.$id.'">http://indonesialiveaboard.com/data/listdetail.php?id='.$id.'</a>';
			...
			{
			echo "Thank you for submitting this request. We will contact you with further details.";
			}
 //-end
		...
		?>
		<div align="center"><a href="#booking"  class="text11">
		Book this cruise</a> | <a href="mailto:cruise@indonesialiveaboard.com" class="text11" >more info about this cruise</a> </div>
</br><br>
	<form action="<?php	                                       			 echo($PHP_SELF);?>" name="sendmail" method="post">
	<a name="booking"></a><strong>Book this cruise</strong><br><br>
	<table width="100%" border="0" align="center" cellpadding="1" class="text11">
	<tr> 
...
?>
<div align="center"><a href="#booking"  class="text11">
		Book this cruise</a> | <a href="mailto:cruise@indonesialiveaboard.com" class="text11" >more info about this cruise</a> </div></br><br>
	<form action="<?php	                                       			 echo($PHP_SELF);?>" name="sendmail" method="post">
	<a name="booking"></a><strong>Book this cruise</strong><br><br>
	<table width="100%" border="0" align="center" cellpadding="1" class="text11">
	<tr> 
