...
<TABLE width="180" height=40 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="775" border=0>
        ...
        <TR>
              ...
              <tr> 
                ...
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p align="center"><img src="wallaceaboats/diveboat01.jpg" alt="indonesia_liveaboard_scuba_diving_wallacea_sulawesi" width="200" height="125" border="1"> <br>
              ...
              <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td bgcolor="#2E3C9D"><table width="100%"  border="0" cellpadding="1" cellspacing="1">
                    <tr>
                      <td height="18" bgcolor="#006699"><span class="style1">&nbsp;&nbsp;<strong>Wallacea Itenary - Banggai Islands</strong></span></td>
                    </tr>
                    <tr>
                        ...
                        <tr>
                          <td colspan="2"><p align="center" class="tdinhalt style3 style11"> <br>
                            ...
                            <p><strong>Day 1 - 
                              ...
                              From cruise departure in front of Maleo Cottage, 2 hours to the 1st dive site. Then 1 hour between 1str and 2 nd . Long ride of 6 hours after the 2 nd dive to each the south of Banggai. We alternatively shift the 2 nd dive and replace by a night dive once arrived.
</p>
                            <p><strong>Day 2 -Dive Location:<br>
 ...
 <strong>P. SAGO:</strong> Drop off along the island of Sago - 1 hour form previous site <br>
 <strong>Siceh:</strong> Other part of the reef, dive for critters - 1 hour &frac12; from previous dive <br>
 <strong>Katini:</strong> Night dive, other part of the reef - &frac12; hour from previous dive <br>
 <br>
...
Banggai Village: A night dive a tiny island in front of Banggai village. <br>A lot to see.                            </p>                            
                            ...
                            <br>
                            <strong>Ali Baba:</strong> Rocks, pinnacles, caves, canyons, hard corals.<br>
                            <strong>Kampanar Bay:</strong> Night Dive <br>
                            <br>
                            <br>
 ...
 <strong>Teku Bay:</strong> Night Dive<br>
                            </p>
...
<strong>Batu Mandi:</strong> A rock goiung down to 15 mts, canyons, gian trevallies - 
 ...
 8 hours sail to Luwuk harbour. Arrival around 6 PM. Night at maleo cottage then fly the following morning.</p>
                            <p><span class="style3 tdinhalt"><span class="tdinhalt"><span class="tdinhalt style3 style11"><a href="wallacea_itenarytogian.php">- Itenary Togian Island</a></span></span></span> </p>
                            <p align="left" class="tdinhalt style3 style11">                                        - <a href="wallacea_togian.php">Dive Destination Togian Island</a></p>
                            <p align="left" class="tdinhalt style3 style11"><a href="wallacea_banggai.php">- Dive Destinataion Banggai Islands</a> <br>
                              <br>
                            </p>                            </td>
                          </tr>
                      </table></td>
            ...
            <div align="center"><br>
                <span class="style3 tdinhalt"><span class="tdinhalt"><span class="style32"><a href="#">- Back to Top</a></span> </span></span><br>
            </div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
