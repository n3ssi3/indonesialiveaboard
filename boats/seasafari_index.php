...
<meta name="keywords" content="raja ampat liveaboard scuba diving cruises,diving cruises,bali,diving,dive resort,wreck diving,dive trip,sulawesi,boat,vessel,island cruises,dive destination irian jaya,dive adventure,luxury liveaboard,exclusive liveaboard,dive safaris,">
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="775" border=0>
        ...
        <TR>
              ...
              <tr> 
                ...
                <div align="center">
                  <p>&nbsp;                  </p>
                  <p><img src="kararu/lunch-buffet-main-salon.jpg" alt="indonesia_liveaboard_scuba_diving_cheng_ho" width="220" height="146"><br>
                  <strong>Lunch Buffet Salon                   </strong></p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p><img src="seasafari/stateroom.jpg" width="180" height="152"><br>
                    <strong>Stateroom                  </strong></p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p><img src="kararu/Sea-Safari _Salon.jpg" alt="indonesia_liveaboard_scuba_diving_cheng_ho" width="220" height="146"><br>
                  <strong>Salon                  </strong> </p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p><img src="seasafari/cinema-wine-room.jpg" width="180" height="152"><br>
                    <strong>Cinema </strong></p>
                </div></TD>
              ...
              <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td bgcolor="#2E3C9D"><table width="100%"  border="0" cellpadding="1" cellspacing="1">
                    <tr>
                      <td height="18" bgcolor="#006699"><span class="style1">&nbsp;&nbsp;<strong>About Kararu Dive Voyages - The &quot;Sea Safari VIII&quot; </strong></span></td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                          <td colspan="2"><p align="center"><span class="style2"><br>
                                    <span class="style11">About Kararu Dive Voyages</span> <br>
                                    <br>
                              </span>.... our objectives, company history, our vessel and the people behind Kararu.<br>
                              <br>
                              <img src="voyagerboats/scuba-logo.jpg" alt="indonesia_liveaboard_scuba_diving_kararu_dive_voyages" width="115" height="119"> </p>
                              <p align="left"> <span class="style12">Our History </span><br>
                                  <br>
        Kararu Dive Voyages liveaboard operation was founded by three young<br> 
        dive enthusiasts; Tony Rhodes, Lisa Crosby and Sascha Dambach. With <br>
        an unrivaled enthusiasm of scuba diving and over twenty years combined <br>
        experience in the diving industry, <a href="http://www.tuttopappagallo.it/"style="text-decoration: none; color:#000000; font-weight: normal;">occhiali da sole</a> these three partners combined their skills<br> 
        to create all that is essential to a first class liveaboard dive operation.<br>
        <br>
        <br>
        <br>
        <span class="style12">Our Objectives</span><br>
        <br>
        Kararu Dive Voyages was started with the objective of bringing Indonesia's <br>
        scarcely seen underwater treasures to a broader base of divers under the <br>
        belief that first hand experience is the key to education and therefore <br>
        conservation.
        Actively assisting in raising funds and awareness for conservation<br> 
        is the cornerstone of the company. Bringing tourism to rarely visited areas of Indonesia and educating the local population in the benefits of reef and fish conservation is the key to preserving the fragile seas of Indonesia.<br>
        <br>
        Kararu Dive Voyages recognizes that it is at the forefront in being able to <br>
        make a long term difference and help to ensure that Indonesia's treasure <br>
        and its local cultures are preserved for the benefit of all.<br>
        <br>
        <br>
        <span class="style12">Our Peoples</span> <br>
        <br>
        Experience on board and behind the scenes is essential to any successful <br>
        scuba diving liveaboard operation.</p>
                              <p align="left">Kararu Dive Voyages has carefully selected and trained a team of 19 Indonesian 
                                crew members from al over the Indonesia archipelago. The combination of these different island cultures, combined with the crew&#8217;s natural and sincere kindness towards others makes for a special team of gifted seamen and friendly <br>
                                personalities.</p>
                              <p align="left">Experienced and professional dive staff are also important, Karl Klingeler and <br>
                                Linda Johnston are Kararu's 2 dynamic dive masters. They are fully qualified <br>
                                PADI, NAUI, BSAC &amp; TDI/SDI instructors with thousands of dives logged. Their <br>
                                local experience and knowledge of marine life habitat will lead you to the secret places only those intimately familiar with the area can.<br>
                                <br>
                                  <br>
                            </p></td>
                        </tr>
                        <tr>
                          <td colspan="2"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td><div align="center"><img src="kararu/sea_safari_deluxe-double-ca.jpg" alt="indonesia_liveaboard_scuba_diving_cheng_ho" width="205" height="136"></div></td>
                              <td>&nbsp;</td>
                              <td><img src="kararu/sea_safari_deluxe-bunk-twin.jpg" alt="indonesia_liveaboard_scuba_diving_cheng_ho" width="205" height="137"></td>
                            </tr>
                          </table></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td colspan="2"><div align="left">
                              <div align="center"><span class="style29">Our Vessel - The &quot;Sea Safari VIII&quot; </span> </div>
                              <p>The KLM Sea Safari VIII is a large and very    spacious luxury Phinisi liveaboard. The classic beauty and elegance from   the KLM Sea Safari VIII combines this traditional craftsmanship with   modern conveniences, providing our guests with luxurious comfort even in   the remotest waters of Indonesia. The ship spans an impressive 44   meters long and 10 meters wide, providing guests with an abundance of   space and luxury. </p>
                              <p><strong>Home Port:</strong> Kararu Dive Voyages and offices and the Sea Safari's home port is Benoa Harbour in the south of Bali. Port of embarkation/disembarkation will change according to the cruise itenary. Port of embarkation/disembarkation is listet on the iternary page. If embarkation/disembarkation is listet as anything other than Bali a domestic flight will be required from Ngurah Rai Airport in south Bali.<br>
                                <br>
                                <strong>Climate:</strong> Tropical, ranges between 25 C (77 F) and 33 C (91 F) </p>
                              <p><strong>Average Water Temperatur:</strong> Ranges between 20 C (72 F) and 30 C (84 F)</p>
                              <p><strong>Photographer Facilities:</strong> Digital rental and course, digital camera and stills editing suite with 10 computer work staions fire wired to CD and DVD burner, slide scanner, 110/220 Volt battery charging station, camera work stations, light tables and loopes, E6 slide film processing and mounting, digital and slide projector, projection screen.</p>
                              <p><strong>Diving:</strong> Dives are conducted from the Voyager's two 24 foot skiffs. Expect to dive a variety of sites including pinnacles, drift dives, sea mounts, piers, walls, slopes, muck and sand.</p>
                              <p> <strong>Max. Number of Divers:</strong> 18 - 20 (possible for full boat charter)</p>
                              <p> <strong>Crew on Board:</strong> 20 boat crew, 2 western cruise directors/dive guides, 2 indonesian dive guides. </p>
                              <p><strong>Alternate activities during the cruise:</strong> National park walks, unlimited shore excursions, beach barbecues, remote village tour, fishing, ocean kayaking, water skiing, jungle trecks hill hiking, snorkelling.</p>
                              <p><strong>Conservation:</strong> Active member of the NMTA, TNC, Komodo Foundation, mooring buoy project, beach clean ups, local village support. <br>
                                  <br>
                              </p>
                            </div>
                              <p align="center" class="style12"> <span class="style29"><span class="style30"><a href="seasafari_boatdetails.php">- Boat Details</a></span></span><a href="#"></a></p></td>
                        </tr>
                        <tr>
                          <td colspan="2">&nbsp;</td>
                        </tr>
            ...
            <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><span class="style40">raja ampat liveaboard scuba diving cruises,diving cruises,bali,diving,dive resort,wreck diving,dive trip,sulawesi,boat,vessel,island cruises,dive destination irian jaya,dive adventure,luxury liveaboard,exclusive liveaboard,dive safaris,</span></td>
              </tr>
            </table></TD>
