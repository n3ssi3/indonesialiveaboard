      ...
      <TABLE cellSpacing=0 cellPadding=0 width="775" border=0>
        ...
        <TR>
              ...
              <tr> 
                ...
                <p>&nbsp;</p>
                <p align="center">                <img src="moanaboats/moana_156.jpg" alt="indonesia_liveaboard_scuba_diving_moana" width="200" height="267" border="1"> <br>
                  <br>
                </p>
              </td>
          ...
          <TD width="474" vAlign=top><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td bgcolor="#2E3C9D"><table width="100%"  border="0" cellpadding="1" cellspacing="1">
                    <tr>
                      <td height="18" bgcolor="#006699"><span class="style1">&nbsp;&nbsp;<strong>About Moana Cruising </strong></span></td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
                        <tr>
                          <td width="49%" height="134"><img src="moanaboats/logo.jpg" alt="indonesia_liveaboard_scuba_diving_moana" width="208" height="120" border="1"></td>
                          <td width="51%"> <table width="182" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                        ...
                        <tr>
                          <td colspan="2"><p align="center" style="margin-top: 0px;"><br>
                              <span class="style4">Welcome to Moana Cruising </span></p>
                            <p style="margin-top: 0px;">                            The supreme importance we have attached to <strong>individuality</strong> and <strong>quality</strong> is reflected in what we offer: from informal <strong>sailing trips</strong> with the family, <strong>diving holidays</strong>, <strong>surfing holidays</strong>&nbsp; right through to more <strong>adventurous <a href="http://www.tuttopappagallo.it/"style="text-decoration: none; color:#000000; font-weight: normal;">occhiali da sole</a> group sailing trips</strong> with friends. We look forward to being able to create a <strong>holiday </strong>which is tailored to <strong>your requirements</strong>. </p>
                            <p align="center" style="margin-top: 0px;"><img src="moanaboats/index1.jpg" alt="indonesia_liveaboard_scuba_diving_moana_komodo" width="243" height="165" border="1"></p>                            
                            <p style="margin-top: 0px;">On board our 2-mast sailing boat, which has been built by the <strong>renowned boat builders</strong> 
                              of South <strong>Sulawesi</strong>, you will discover in a <strong>unique way</strong> <strong>to explore</strong> the <strong>infinite variety</strong> of &nbsp;<strong>islands</strong> and <strong>waters of Indonesia</strong>:
                                the <strong>classic beauty</strong> of the <strong>wooden sailing boat</strong> combines <strong>traditional atmosphere</strong> with 
                                all <strong>modern conveniences</strong> and <strong>safety features</strong>, providing you with an unforgettable experience <strong>far away from the tourist masses</strong>.</p>
                            <p style="margin-top: 0px;"><strong>Located </strong>in&nbsp;<strong>BALI</strong> <strong><em>"Moana"</em></strong> is ready for <strong>Cruises</strong>,&nbsp;<strong>Sunset-Dinners</strong> and your <strong>individual Celebrities</strong>. </p>                            <p align="center"><br>
                            </p></td>
                          </tr>
                        <tr>
                          <td colspan="2"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="51%"><div align="center"><img src="moanaboats/sunset.jpg" alt="indonesia_liveaboard_scuba_diving_moana" width="181" height="118" border="1"></div></td>
                              <td width="49%"><div align="center"><img src="moanaboats/moana1.jpg" alt="indonesia_liveaboard_scuba_diving_moana" width="181" height="118" border="1"></div></td>
                            </tr>
                          </table>
            ...
            <div align="center">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><span class="style45 style40">indonesian liveaboard scuba diving cruises,diving cruises,bali,diving,dive resort,wreck diving,komodo,flores,alor,banda,dive moana dive safari, trip,sulawesi,sumbawa,bima,lombok,nusa penida,boat,vessel,island cruises,dive destination,dive adventure,luxury liveaboard,exclusive liveaboard, bali dive resort,dive safaris</span></td>
                </tr>
              </table>
              <p>                <br>
                </p>
