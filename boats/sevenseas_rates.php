      ...
      <TABLE cellSpacing=0 cellPadding=0 width="775" border=0>
        ...
        <TR>
              ...
              <tr>
                ...
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p align="center"><img src="sevenseas/rates1.jpg" width="250" height="188"></p>
              </TD>
          ...
          <TD width="474" vAlign=top><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td bgcolor="#2E3C9D"><table width="100%"  border="0" cellpadding="1" cellspacing="1">
                    <tr>
                      <td height="18" bgcolor="#006699"><span class="style1">&nbsp;&nbsp;<strong>Seven Seas - Liveaboard Diving Rates </strong></span></td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                          <td colspan="2"><p align="center"><br>
                            <br>
                            <span class="style15">Seven Seas Dive Cruise Rates </span></p>
                            <p align="left"><strong>Domestic flights to the port of destination are not included in below rates.</strong><BR>
                            </p>
                            <H2 class="style84">Rates 2013 &amp; 2014                            </H2>
                            <p>Domestic flights to the port of destination are not included in below rates.</p>
                            <br>
                            <table cellpadding="3" cellspacing="0" width="100%">
                              <tbody>
                                <tr>
                                  <td rowspan="2" align="center" valign="bottom">Destination</td>
                                  <td colspan="3" align="center">Trip Length</td>
                                </tr>
                                <tr>
                                  <td align="center" width="16%">1-7 nights</td>
                                  <td align="center" width="16%">8-14 nights</td>
                                  <td align="center" width="16%">&gt;14 nights</td>
                                </tr>
                                <tr>
                                  <td><strong>Bali, Komodo National Park, Wakatobi, East of Flores, Savu Sea</strong><br>
                                    <div>per person per night</div>
                                    <div>8 cabins = full charter per night</div>
                                    <div>6 cabins = &frac34; charter per night</div>
                                    <div>4 cabins = &frac12; charter per night</div></td>
                                  <td align="center"><br>
                                    <br>
                                    US$ 475<br>
                                    US$ 6,175<br>
                                ...
                                <tr>
                                  <td><strong>Banda Sea, Forgotten Islands, Raja Ampat, Cenderawasih, Asmat</strong><br>
                                    <div>per person per night</div>
                                    <div>8 cabins = full charter per night</div>
                                    <div>6 cabins = &frac34; charter per night</div>
                                    <div>4 cabins = &frac12; charter per night</div></td>
                            ...
                            <p>There is NO FUEL SURCHARGE for 2013-2014 and NITROX is FREE OF   CHARGE. Any and all port clearance and conservation fees are INCLUDED in   the above pricing. NO SURCHARGES!</p>
                            <p><strong>&raquo; <a href="http://www.thesevenseas.net/terms.html" rel="nofollow">Terms &amp; Conditions</a></strong>                            </p>
                            <p><BR>
                            </p></td>
                          </tr>
                      </table></td>
            ...
            <h2 align="center" class="style15"><span class="style18"><a href="#">- Back Top</a></span> </h2>
