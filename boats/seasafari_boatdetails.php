      ...
      <TABLE cellSpacing=0 cellPadding=0 width="775" border=0>
        ...
        <TR>
              ...
              <tr>
                ...
                <div align="center">
                  <p>&nbsp;</p>
                  <p><img src="kararu/Sea-Safari _Salon.jpg" alt="indonesia_liveaboard_scuba_diving_cheng_ho_salon" width="220" height="146"><br>
              ...
              <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td bgcolor="#2E3C9D"><table width="100%"  border="0" cellpadding="1" cellspacing="1">
                    <tr>
                      <td height="18" bgcolor="#006699"><span class="style1">&nbsp;&nbsp;<strong>Sea Safari VIII   - Boat Details </strong></span></td>
                    </tr>
                    <tr>
                      <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                          <td colspan="2"><p align="center"><br>
                                          <span class="style15">The Phinisi Schooner  &quot;Sea Safari VIII&quot; </span></p>
                                        <p align="left">The KLM Sea Safari VIII is one of Indonesia's largest and most spacious   luxury Phinisi liveaboard. One of the very few dive vessels in Indonesia   built according to international marine class specifications, the ship   spans an impressive 44 meters long and 10 meters wide providing guests   with an abundance of space and luxury. The Sea Safari VIII is our new   dedicated vessel for all scheduled cruises in the Far East of the   Indonesian Archipelago including the Raja Ampat region.</p>
                                        <p>Indonesian 'Bugis Prahus', commonly known as Phinisi, are made from   locally grown timber according to a tradition that dates back to long   before Portuguese colonists reached the area. The classic beauty and   elegance from the Sea Safari VIII combines this traditional   craftsmanship with modern conveniences, providing our guests with   luxurious comfort even in the remotest waters of the Indonesian   archipelago. The Sea Safari VIII is Indonesia's ultimate luxury   liveaboard scuba diving vessel.</p>
                                        <h2>Vessel Specifications</h2>
                                        <p>The vessel has been extensively customized and refitted   to suit long range live aboard scuba diving expeditions and underwater   photography. Constructed with three decks the Sea Safari VIII gives you   plenty of space to lose oneself; whether it is in the air-conditioned   comfort of the large saloon or on the decks under the shade of one of   the ship's huge sails.</p>
                                        <table border="1" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td width="25%">Type: Phinisi Schooner</td>
                                            <td width="25%">Hull: Ulin Wood (Iron Wood)</td>
                                            <td width="25%">Gross Tonnage: 245 GT</td>
                                            <td>Cruising Speed: 8-10 Knots</td>
                                          </tr>
                                          <tr>
                                            <td>Length: 44 Metres (145 Feet)</td>
                                            <td>Beam: 10 Metres (36 Feet)</td>
                                            <td>Draft: 3.5 Metres (12 Feet)</td>
                                            <td>Fuel Capacity: 40 Tons</td>
                                          </tr>
                                          <tr>
                                            <td>Main Engine: 450 hp Deutz </td>
                                            <td>Generators: 1x25kw, 1x40kw, 1x60kw</td>
                                            <td>Water Capacity: 40 Tons</td>
                                            <td>Desalinator: 8 Tons/Day</td>
                                          </tr>
                                        </table>
                                        <p>&nbsp; </p>
                                        <table border="1" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td width="50%"><h3>Safety Equipment</h3>
                                                <ul>
                                                  <li>4 Units Inflatable Life Rafts</li>
                                                  <li>60 Life Jackets</li>
                                                  <li>12 Life Buoys</li>
                                                  <li>Smoke Detectors </li>
                                                  <li>Fire Hoses &amp; Hydrants</li>
                                                  <li>C02 &amp; Powder Fire Extinguishers</li>
                                                </ul></td>
                                            <td><h3>Dive Support Equipment</h3>
                                                <ul>
                                                  <li>3 x Bauer Air Compressors</li>
                                                  <li>1 x Nitrox Blending Unit</li>
                                                  <li>1 x Aluminum Dive Tender - 620 cm - 2 x 40 hp</li>
                                                  <li>2 x Aluminium Dive Tender - 520 cm - 1 x 85 hp</li>
                                                </ul></td>
                                          </tr>
                                          <tr>
                                            <td><h3>Accommodation</h3>
                                                <ul>
                                                  <li>3 x Below Deck Twin [Capacity: 2 pax/cabin]</li>
                                                  <li>4 x Below Deck Single [Capacity: 1 pax/cabin]</li>
                                                  <li>4 x Main Deck Double [Capacity: 2 pax/cabin]</li>
                                                </ul></td>
                                            <td><h3>Navigation &amp; Communication</h3>
                                                <ul>
                                                  <li>1 x Faruno 1832 Chart Plotter with GPS</li>
                                                  <li>1 x Faruno GPS</li>
                                                  <li>1 x Faruno Radar</li>
                                                  <li>1 x Faruno Echo Sounder</li>
                                                  <li>1 x VHF + 1 x SSB Radios</li>
                                                  <li>1 x Satellite Phone</li>
                                                </ul></td>
                                          </tr>
                                        </table>
                                      </td>
